...
export interface ISuperfluidToken$Type {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<ISuperfluidToken$Type["abi"]>>;
  export function deployContract(
    contractName: "@superfluid-finance/ethereum-contracts/contracts/interfaces/superfluid/ISuperfluidToken.sol:ISuperfluidToken",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<ISuperfluidToken$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<ISuperfluidToken$Type["abi"]>;
