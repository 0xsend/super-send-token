...
## 4440c4a Add Superfluid config and deployments scaffold

Why:
Provide network config and wrapper deployment caches to
enable deterministic wrapper discovery and creation.

Test plan:
- Inspect config/superfluid.ts values.
- Verify deployments/wrapper.*.json exist.
